public class Constants {
    ...
    public const string IS_BIG = "IsBig";
    public const string IS_HIT_NOW = "isHitNow";
    public const string IS_MUSHROOM = "isMushroom";
    ...
    public const string MUSHROOM_TAG = "Mushroom";
